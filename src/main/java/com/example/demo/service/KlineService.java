...
public class KlineService {
    ...
    @Transactional
    public void load(@NotBlank String symbol, @NotNull Long startingTime, @NotNull Long endingTime, @NotBlank String runName) {
...
//        if (rollingUpAmount != null || rollingUpAmount.equals("d") || rollingUpAmount.equals("m")) {
//            List<Kline> listRolled = rollingUpService.rollingUp(listTrans, rollingUpAmount);
